...
/**
 * `parseAmount`/`validateAmount` moraram aqui até a correção do bug de
 * vírgula em Produtos (24/08/2026) mostrar que o mesmo parser era necessário
 * em outro módulo — agora vivem em `src/lib/amount.ts`, reexportados daqui
 * para não quebrar quem já importa de `finance.ts` (cashcontrol/*).
 */
